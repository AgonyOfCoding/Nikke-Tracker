    ...
    return (
        <>
            ...
            <Dialog isOpen={dialog_open} title="About" onClose={() => setDialogOpen(false)} >
                <DialogBody>
                    <p><a href="https://github.com/AgonyOfCoding/Nikke-Tracker" target="_blank" rel="noreferrer" >Github repository</a></p>
                    ...
                    <p>Nikke profile icons from <a href="https://nikke-db.pages.dev/tierlistmaker" target="_blank" rel="noreferrer" >Nikke-DB</a>. Other icons screenshots from the game.</p>
                    <h3>Hints</h3>
                    <p>Shift+click changes most values in larger increments.</p>
                    <p>Not all equipment levels have icons, belive the numbers next to the icon.</p>
                </DialogBody>
                <DialogFooter
                    actions={
                        <Button
